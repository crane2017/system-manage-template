...
@Data
@ApiModel("编辑部门参数")
public class EditAdminDepartmentParameter {

    @ApiModelProperty("部门id")
    private Integer adminDptPkid;
    ...
    public Integer getAdminDptPkid() {
        return adminDptPkid;
    }

    public void setAdminDptPkid(Integer adminDptPkid) {
        this.adminDptPkid = adminDptPkid;
    }
